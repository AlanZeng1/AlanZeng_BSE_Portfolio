...
# Reflection
After finishing my project, I realized that I learned a lot during this whole process. I learned to plan ahead, so that I would be able to complete goals on time. I learned to Google search effectively, so I can find resources to learn about the different parts of my project. Most importantly, I learned to persevere and keep trying, because even if something doesn't work the first time, it eventually will. Additionally, I realized that I really enjoyed the hands on part of this project. Participating in this program and building this project has motivated me to continue learning more about the different fields of science, and I hope to build more hardware and software projects in the future!
